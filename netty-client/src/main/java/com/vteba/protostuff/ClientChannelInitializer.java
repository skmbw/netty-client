...
import com.vteba.netty.codec.ProtosDecoder;
import com.vteba.netty.codec.ProtosEncoder;
import com.vteba.netty.protostuff.HeartBeatHandler;
...
public class ClientChannelInitializer extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel ch) throws Exception {
		...
		// 1、将字符转字节数组
		pipeline.addLast("encoder", new ProtosEncoder());
		...
		// 2、将数组编码为字符串
		pipeline.addLast("decoder", new ProtosDecoder(Node.class));
